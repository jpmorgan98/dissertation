...
%%%%% JPM PACAKGES AN COMMANDS

% for tabels and code
\usepackage{multirow} % multiple rows in tables
\usepackage{longtable} % long tables
\usepackage{minted} % code snipits
\usepackage{algorithm2e} % in-text psudo code
...
\textit{This work was supported by the Center for Exascale Monte-Carlo Neutron Transport (CEMeNT) a PSAAP-III project funded by the Department of Energy, grant number: DE-NA003967.}
...
In measured weight and penny pound my life is not worth living if I surrender on this ordinate my God has called me to.
...
\include{deterministic/deterministic}
