...
\renewcommand{\cftsecfont} % section titles
             {\usefont{T1}{ugm}{m}{n}\selectfont}
\renewcommand{\cftsubsecfont} % subsection titles
             {\usefont{T1}{ugm}{m}{n}\selectfont} 
\renewcommand{\cftchappagefont} % chapter page numbers
             {\usefont{T1}{ugm}{b}{n}\selectfont}
\renewcommand{\cftsecpagefont} % section page numbers
             {\cftsecfont} 
\renewcommand{\cftsubsecpagefont} % subsection page numbers
             {\cftsubsecfont}
             
\renewcommand{\appendixpagename}{\usefont{T1}{qhv}{b}{n}\selectfont\huge Appendices}
...
\pdfinfo{/Author (Joanna Piper Morgan)
           ...
           /Keywords (radiation transport, phd, dissertation, monte carlo, source iteration, one cell inversion, gpu, von neumann analysis, Fourier analysis, numerical stability, richerdson iteration, DSA, diffusion synthetic acceleration, preconditioning, HPC, time dependent, surface tracking, delta tracking, woodcock tracking, neutron transport, stochastic solvers)}